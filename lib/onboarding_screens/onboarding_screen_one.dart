...
class OnboardingScreenOne extends StatelessWidget {
  ...
  static String id = '/onboarding-one';
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              BounceIn(
                key: basicAnimation2,
                child: Image.asset('assets/images/png/Onboarding Image 2.png'),
              ),
              const SizedBox(
                height: 50
              ),
              ...
              Padding(
                ...
                child: BounceInDown(
                  key: basicAnimation4,
                  child: Text(
                    'A platform where wholesalers and retailers can easily connect, upload products, and manage bulk orders',
                    textAlign: TextAlign.center,
                ...
                children: [
                  ...
                  BounceInLeft(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, OnboardingScreenTwo.id);
                      },
                      icon: const Icon(
                        Icons.arrow_forward,
                        color: Colors.white,
